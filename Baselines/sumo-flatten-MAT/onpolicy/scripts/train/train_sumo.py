...
if __name__ == "__main__":
    for i in range(0, 1):
        ...
        # index = int(args_[1]) # 训练哪个地图？ # grid44:0   art44: 3    grid55: 6   colo: 5  nanshan: 2
        # CUDA_VISIBLE_DEVICES=0 python train_sumo.py 0
        # CUDA_VISIBLE_DEVICES=1 python train_sumo.py 3
        # CUDA_VISIBLE_DEVICES=1 python train_sumo.py 6
        # CUDA_VISIBLE_DEVICES=2 python train_sumo.py 5
        # CUDA_VISIBLE_DEVICES=2 python train_sumo.py 2
