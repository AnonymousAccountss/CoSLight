...
class Runner(object):
    ...
    def __init__(self, config):
        ...
        if self.all_args.use_ours:
            from onpolicy.algorithms.r_mappo.algorithm.rMAPPOPolicy import R_MAPPOPolicy_Advanced as Policy
            from onpolicy.algorithms.r_mappo.r_mappo import R_MAPPO_Trans as TrainAlgo
