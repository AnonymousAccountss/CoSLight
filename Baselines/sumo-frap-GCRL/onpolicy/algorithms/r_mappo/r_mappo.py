...
class R_MAPPO_Trans():
    ...
    def ppo_update(self, sample, update_actor=True):
        ...
        # actor update
        action_log_probs = action_log_probs.reshape(old_action_log_probs_batch.shape)
        ...
        if len(values.shape) == 3: # reshape 成两维
        ...
        return value_losses, critic_grad_norm, policy_loss, dist_entropy, actor_grad_norm, imp_weights, (kl_loss, 0.0, diag_mean_loss, sym_loss, 0.0)
        ...
        for _ in range(self.ppo_epoch):
            ...
            for sample in data_generator:
                if not self.args.use_kl:
                    ...
                    train_info['loss/score_dist_entropy'] += score_dist_entropy
