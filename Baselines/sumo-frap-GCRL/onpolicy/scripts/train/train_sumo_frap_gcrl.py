...
if __name__ == "__main__":
    ...
    # for i in range(4, 5):
        ...
        # model_dir_root = '/home/xingdp/jqruan/data/TSC/sumo-frap-GCRL-v9-sumolib-final-ablation-K/onpolicy/scripts/results_sumo/SUMO/'
        # eval_model_path = [
        #     f'SUMO-best-grid4x4/grid4x4-K_{K}/grid4x4-frap-GCRL-ippo_thr_2/ippo/seed_0_run1/models/',
        #     '',
        #     'SUMO-best-nanshan/nanshan-K_1/nanshan-frap-GCRL-ippo_thr_2/ippo/seed_0_run1_161/models/',
        #     # 'SUMO-best-arterial4x4/arterial4x4-K_1/arterial4x4-frap-GCRL-ippo_thr_2/ippo/seed_0_run1/models/',
        #     f'SUMO-best-arterial4x4-v1/arterial4x4-K_{K}/arterial4x4-frap-GCRL-ippo_thr_2/ippo/seed_0_run1/models/',
        #     '',
        #     # 'SUMO-best-cologne8/cologne8-K_1/cologne8-frap-GCRL-ippo_thr_2/ippo/seed_0_run1/models/',
        #     f'SUMO-best-cologne8-v1/cologne8-K_{K}/cologne8-frap-GCRL-ippo_thr_2/ippo/seed_0_run1/models/',
        #     # 'SUMO-best-grid5x5/grid5x5-K_1/grid5x5-frap-GCRL-ippo_thr_2/ippo/seed_0_run1/models/',
        #     f'SUMO-best-grid5x5-v1/grid5x5-K_{K}/grid5x5-frap-GCRL-ippo_thr_2/ippo/seed_0_run1/models/'
        # ]
        ...
        if index == 0: 
            ...
            if fix_matrix == 0:
                ...
                cong_flag = f'SUMO-best-frap-GCRL/20240406/'
            ...
            args.extend(['--fix_matrix', str(fix_matrix)])
            if fix_matrix == 0:
                cong_flag = f'SUMO-best-frap-GCRL/fix_matrix/'
            elif fix_matrix == 1:
                cong_flag = f'SUMO-best-frap-GCRL/random_matrix/'
            else:
                cong_flag = f'SUMO-best-frap-GCRL/20240406/'
        ...
        cong_lst = ['grid4x4-frap-GCRL-', 'fenglin-frap-GCRL-', 'nanshan-frap-GCRL-',
                    'arterial4x4-frap-GCRL-', 'ingolstadt21-frap-GCRL-', 'cologne8-frap-GCRL-', 'grid5x5-frap-GCRL-']
        ...
        main(args)
        # CUDA_VISIBLE_DEVICES=5 python train_sumo_frap_gcrl.py 0 
        # CUDA_VISIBLE_DEVICES=6 python train_sumo_frap_gcrl.py 3 
        # CUDA_VISIBLE_DEVICES=6 python train_sumo_frap_gcrl.py 6 
        # CUDA_VISIBLE_DEVICES=7 python train_sumo_frap_gcrl.py 5 
        # CUDA_VISIBLE_DEVICES=7 python train_sumo_frap_gcrl.py 2 
        # grid44:0   art44: 3    grid55: 6   colo: 5  nanshan: 2
        # cd /home/jqruan/data/TSC-161/add_baselines/sumo-frap-GCRL/onpolicy/scripts/train; conda activate tsc-debug
