...
if __name__ == "__main__":
    ...
    # for i in range(4, 5):
        ...
        model_dir_root = '/home/jqruan/data/TSC-161/add_baselines/sumo-frap-GCRL/onpolicy/scripts/results_sumo/SUMO/SUMO-best-frap-GCRL/20240406/'
        id_list = [624, -1, 320, 540, -1, 624, 270]
        eval_model_path = [
            f'/grid4x4-frap-GCRL-ippo_thr_2/ippo/seed_0_run1/models/',
            '',
            '/nanshan-frap-GCRL-ippo_thr_2/ippo/seed_0_run1/models/',
            f'/arterial4x4-frap-GCRL-ippo_thr_2/ippo/seed_0_run1/models/',
            '',
            f'/cologne8-frap-GCRL-ippo_thr_2/ippo/seed_0_run1/models/',
            f'/grid5x5-frap-GCRL-ippo_thr_2/ippo/seed_0_run1/models/'
        ]
        ...
        main(args)
        # CUDA_VISIBLE_DEVICES=0 python eval_sumo_frap_gcrl.py 0 
        # CUDA_VISIBLE_DEVICES=0 python eval_sumo_frap_gcrl.py 3 
        # CUDA_VISIBLE_DEVICES=1 python eval_sumo_frap_gcrl.py 6 
        # CUDA_VISIBLE_DEVICES=1 python eval_sumo_frap_gcrl.py 5 
        # CUDA_VISIBLE_DEVICES=3 python eval_sumo_frap_gcrl.py 2 
