...
if __name__ == "__main__":
    for i in range(0, 1):
        ...
        # args.extend(['--model_dir', '/home/xingdp/jqruan/data/TSC/sumo-frap-mappo-ippo/onpolicy/scripts/results_sumo/SUMO-GAT/' + eval_model_path[index] + '-gat-0406_thr_2/ippo/seed_0_run1/models'])
        main(args)
        
        # cd /home/jqruan/data/TSC-161/add_baselines/sumo-frap-mappo-ippo-GCRL/onpolicy/scripts/train; conda activate tsc;
        # index = int(args_[1]) # 训练哪个地图？ # grid44:0   art44: 3    grid55: 6   colo: 5  nanshan: 2
        # CUDA_VISIBLE_DEVICES=6 python train_sumo.py 0
        # CUDA_VISIBLE_DEVICES=6 python train_sumo.py 3
        # CUDA_VISIBLE_DEVICES=7 python train_sumo.py 6
        # CUDA_VISIBLE_DEVICES=5 python train_sumo.py 5
        # CUDA_VISIBLE_DEVICES=5 python train_sumo.py 2
