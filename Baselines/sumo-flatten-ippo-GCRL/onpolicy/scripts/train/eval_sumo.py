...
if __name__ == "__main__":
    for i in range(0, 1):
        ...
        cong_flag = f'SUMO-best-GCRL/20240406/'
        
        cong_lst = ['grid4x4-GCRL-', 'fenglin-GCRL-', 'nanshan-GCRL-',
                    'arterial4x4-GCRL-', 'ingolstadt21-GCRL-', 'cologne8-GCRL-', 'grid5x5-GCRL-']
        ...
        id_list = [3, -1, 3, 3, -1, 3, 3]
        model_dir_root = '/home/jqruan/data/TSC-161/add_baselines/sumo-frap-mappo-ippo-GCRL/onpolicy/scripts/results_sumo/SUMO/SUMO-best-GCRL/20240406/'
        eval_model_path = [
            f'/grid4x4-GCRL-ippo_thr_2/ippo/seed_0_run1/models/',
            '',
            '/nanshan-GCRL-ippo_thr_2/ippo/seed_0_run1/models/',
            f'/arterial4x4-GCRL-ippo_thr_2/ippo/seed_0_run1/models/',
            '',
            f'/cologne8-GCRL-ippo_thr_2/ippo/seed_0_run1/models/',
            f'/grid5x5-GCRL-ippo_thr_2/ippo/seed_0_run1/models/'
        ]
        ...
        # cd /home/jqruan/data/TSC-161/add_baselines/sumo-frap-mappo-ippo-GCRL/onpolicy/scripts/train; conda activate tsc;
        # index = int(args_[1]) # 训练哪个地图？ # grid44:0   art44: 3    grid55: 6   colo: 5  nanshan: 2
        # CUDA_VISIBLE_DEVICES=0 python eval_sumo.py 0
        # CUDA_VISIBLE_DEVICES=0 python eval_sumo.py 3
        # CUDA_VISIBLE_DEVICES=1 python eval_sumo.py 6
        # CUDA_VISIBLE_DEVICES=1 python eval_sumo.py 5
