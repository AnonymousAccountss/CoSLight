...
class SUMORunner(SUMOBaseRunner):
    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            for step in range(self.episode_length):
                ...
                data = obs, rewards, dones, infos, values, actions[:,:,None].astype(np.int64), action_log_probs[:,:,None], available_actions
    ...
    def insert(self, data):
        obs, rewards, dones, infos, values, actions, action_log_probs, available_actions = data
        ...
        self.buffer.insert(share_obs, obs, actions, action_log_probs, values, rewards, masks, available_actions=available_actions)
